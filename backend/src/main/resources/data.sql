...
('U103', '陈审', 'chenshen', '100202', 'SUB_BRANCH', '审计专员'),
...
('DEMO_REPORT_QUERY', 'REPORT_VIEWER', 'HEAD_OFFICE', null, 'SELF_AND_DESCENDANTS', true),
('DEMO_REPORT_QUERY', 'REPORT_VIEWER', 'BRANCH', null, 'SELF_AND_DESCENDANTS', true),
('DEMO_REPORT_QUERY', 'REPORT_VIEWER', 'SUB_BRANCH', null, 'SELF_ONLY', true),
('DEMO_REPORT_QUERY', 'BRANCH_MANAGER', 'BRANCH', null, 'SELF_AND_DESCENDANTS', true),
('DEMO_REPORT_QUERY', 'BRANCH_MANAGER', 'SUB_BRANCH', null, 'PARENT_AND_DESCENDANTS', true),
('DEMO_REPORT_QUERY', 'AUDITOR', 'SUB_BRANCH', '审计', 'PARENT_AND_DESCENDANTS', true);

insert into ds_user_override_rule(user_id, page_code, role_code, scope_type, enabled) values
('U105', 'DEMO_REPORT_QUERY', 'REPORT_VIEWER', 'ALL_ORGS', true);
